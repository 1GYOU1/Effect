$(function() {
    $(".source_box h3 a").click(function(){
...
var __globalBxslider = {
    ...
    setup:function(idx, attr){
        ...
        var _cutLimit = $(attr).attr("data-cutLimit"); // 슬라이드 제한
        _cutLimit = _cutLimit && !isNaN(parseInt(_cutLimit)) ? parseInt(_cutLimit) : null;
        ...
        var _pagerType = $(attr).attr("data-pagerType");
        ...
        __globalBxslider.bxList[__globalBxslider.bxList.length] = attr.bxSlider = $('.bxslider',attr).bxSlider({
            ...
            ,onSlideAfter:function(el){
                // main
                if(el.context.className.indexOf("slide-main") > 0) {
                    mainNumberCounter(1);
                }
            }
            //infiniteLoop: false
